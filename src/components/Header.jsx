    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <div>
            <p className="text-headingColor text-xl font-bold">KALAKALAN</p>
            <p className="text-headingColor text-xs font-bold ">Cafe & Resto</p>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "vantoineludel@gmail.com" && (
                  <Link to={"/createItem"}>
...
<ul
          ...
          >
            <li className="text-base text-textColor hover:text-headingColor cursor-pointer hover:bg-slate-200 px-4 py-2"
            onClick={() => setIsMenu(false)}
            >
              Home
            </li>
